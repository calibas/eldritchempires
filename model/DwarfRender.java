...
public class DwarfRender extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:model/texture/rabidDwarf.png");
	private DwarfModel model;
	
	public DwarfRender(DwarfModel dwarfModel) {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderDwarf((RabidDwarf) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderDwarf((RabidDwarf) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderDwarf(RabidDwarf rabidDwarf,
