...
public class StoneArcherRender extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:model/texture/stoneArcher.png");
	
	public StoneArcherRender() {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderStoneArcher((StoneArcher) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderStoneArcher((StoneArcher) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderStoneArcher(StoneArcher StoneArcher,
