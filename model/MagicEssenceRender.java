...
public class MagicEssenceRender extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:model/texture/magicEssence.png");
	
	public MagicEssenceRender() {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderMagicEssence((MagicEssence) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderMagicEssence((MagicEssence) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderMagicEssence(MagicEssence MagicEssence,
