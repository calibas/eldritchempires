...
//		System.out.println("isTrapdoorOpen " + ((meta & 4) != 0) + " meta " + meta);
//	}
    ...
    //Does nothing? Returning true or false does the same, mobs avoid walking over block. Removing method makes mobs path over it no matter what.
    @Override
