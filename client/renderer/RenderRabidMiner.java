...
public class RenderRabidMiner extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:textures/models/rabidMiner.png");
	private RabidMinerModel model;
	
	public RenderRabidMiner(RabidMinerModel dwarfModel) {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderDwarf((EntityRabidMiner) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderDwarf((EntityRabidMiner) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderDwarf(EntityRabidMiner rabidMiner,
			double d, double d1, double d2, float f, float f1)
	{
		super.doRenderLiving(rabidMiner, d, d1, d2, f, f1);
	}
