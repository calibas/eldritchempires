...
public class RenderDwarf extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:textures/models/rabidDwarf.png");
	private DwarfModel model;
	
	public RenderDwarf(DwarfModel dwarfModel) {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderDwarf((EntityRabidDwarf) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderDwarf((EntityRabidDwarf) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderDwarf(EntityRabidDwarf rabidDwarf,
