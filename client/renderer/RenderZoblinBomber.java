...
import eldritchempires.client.model.ZoblinBomberModel;
import eldritchempires.entity.EntityZoblinBomber;

public class RenderZoblinBomber extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:textures/models/zoblinBomber.png");
	
	public RenderZoblinBomber() {
...
//    }
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderZoblinBomber((EntityZoblinBomber) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderZoblinBomber((EntityZoblinBomber) entityliving, d, d1, d2, f,
				f1);
	}
	...
	public void renderZoblinBomber(EntityZoblinBomber ZoblinBomber,
