...
public class RenderZoblinBoss extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:textures/models/zoblinBoss.png");
	
	public RenderZoblinBoss() {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderZoblin((EntityZoblinBoss) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderZoblin((EntityZoblinBoss) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderZoblin(EntityZoblinBoss zoblinBoss,
