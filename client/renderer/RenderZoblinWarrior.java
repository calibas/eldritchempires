...
import eldritchempires.client.model.ZoblinModel;
import eldritchempires.entity.EntityZoblinWarrior;

public class RenderZoblinWarrior extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:textures/models/zoblinWarrior.png");
	
	public RenderZoblinWarrior() {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderZoblin((EntityZoblinWarrior) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderZoblin((EntityZoblinWarrior) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderZoblin(EntityZoblinWarrior zoblinWarrior,
