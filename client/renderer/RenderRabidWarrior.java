...
public class RenderRabidWarrior extends RenderBiped {
	...
	public RenderRabidWarrior(DwarfModel dwarfModel) {
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderDwarf((EntityRabidWarrior) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderDwarf((EntityRabidWarrior) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderDwarf(EntityRabidWarrior rabidWarrior,
			double d, double d1, double d2, float f, float f1)
	{
		super.doRenderLiving(rabidWarrior, d, d1, d2, f, f1);
	}
