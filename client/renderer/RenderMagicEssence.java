...
import eldritchempires.client.model.MagicEssenceModel;
import eldritchempires.entity.EntityMagicEssence;

public class RenderMagicEssence extends RenderBiped {
	
	private static final ResourceLocation textureLocation = new ResourceLocation("eldritchempires:textures/models/magicEssence.png");
	
	public RenderMagicEssence() {
		super(new MagicEssenceModel(), 0.0F);
	}
	...
	public void doRender(Entity entity, double d, double d1, double d2,
			float f, float f1)
	{
		renderMagicEssence((EntityMagicEssence) entity, d, d1, d2, f, f1);
	}
	...
	{
		renderMagicEssence((EntityMagicEssence) entityliving, d, d1, d2, f,
				f1);
	}
...
//    }
	...
	public void renderMagicEssence(EntityMagicEssence MagicEssence,
			double d, double d1, double d2, float f, float f1)
	{
		super.doRenderLiving(MagicEssence, d, d1, d2, f, f1);
	}
