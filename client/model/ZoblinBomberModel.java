...
public class ZoblinBomberModel extends ModelBiped
{
	//fields
    ModelRenderer head;
    ModelRenderer body;
  ...
  public ZoblinBomberModel()
  {
    ...
    textureHeight = 64;
      ...
      tnt = new ModelRenderer(this, 32, 0);
      tnt.addBox(-4F, 3F, -10F, 8, 8, 8);
      tnt.setRotationPoint(0F, 0F, 0F);
      tnt.setTextureSize(64, 64);
