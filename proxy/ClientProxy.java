...
import eldritchempires.client.renderer.RenderBomb;
import eldritchempires.client.renderer.RenderBomb;
...
import eldritchempires.client.renderer.RenderRabidDemo;
...
public class ClientProxy extends CommonProxy {
    ...
    public void registerRenderers() {
    	...
    	RenderingRegistry.registerEntityRenderingHandler(EntityRabidDemo.class, new RenderRabidDemo(new DwarfModel()));
